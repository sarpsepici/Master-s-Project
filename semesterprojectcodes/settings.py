...
PIEZO_RESONANCES = {0: 1950, 1: 2040, 2: 2050, 3: 2100}  # kHz
PIEZO_RESONANCES_2 = {0: 1130, 1: 1130, 2: 1040, 3: 1090}  # kHz
PIEZO_RESONANCES_MEDIUM = {0: 1790, 1: 1780, 2: 1860, 3: 1900}  # kHz
...
EXPERIMENT_RUN_NAME = 'AVG_NORMALIZED_QS_O'  # Use a descriptive name here so you know what you did during the experiment
...
MODELS_FOLDER = f'E:\\models'
MODEL_NAME = f'{EXPERIMENT_RUN_NAME}.npy'
...
MAX_VELO = 10
Q_VALUES_UPDATE_KERNEL_FUNC = lambda x, y: np.log(x**2 + y**2 + 1e-4)
